...
function calculGenerateurs(A::Array{Int,2}, c1::Array{Int,1}, c2::Array{Int,1}, 
                           ...
                           d::tListDisplay, instance::String)
    ...
    while maxf2RLlimite > minf2RLlimite
        ...
        if alternance % 2 == 0
            ...
            f1RL, xf1RL = computeLinearRelax2SPA(nbvar, nbctr, A, c1, c2, maxf2RL - (j1-1) * pasSample2, 1, instance)
            ...
            # calcul d'une solution epsilon-contrainte
            f2RL, xf2RL = computeLinearRelax2SPA(nbvar, nbctr, A, c1, c2, maxf1RL - (j2-1) * pasSample1, 2, instance)
